...
export const SocialEngagementCard = ({
  analytics,
}: {
  ...
  const data = [
    ...
    {
      name: "Reposts",
      value: analytics.engagement.reposts ?? 0,
      color: "#10b981",
    },
    { name: "Stories", value: analytics.stories.total ?? 0, color: "#f59e0b" },
    {
      name: "Contact Messages",
      value: analytics.contactMessages.total ?? 0,
      color: "#ec4899",
    },
  ];
  ...
  return (
    <div className="p-5 rounded-3xl bg-white border border-slate-100 shadow-sm relative overflow-hidden group">
      ...
      <p className="text-xs font-black text-slate-400 uppercase tracking-widest mb-6">
        {analytics.social.follows.toLocaleString()} Follows
      </p>
